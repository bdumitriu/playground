...
public interface Repository extends Remote
{
	 ...
	 * <br /><br />
	 * @param currentState the tree representing the state of the graphical document
	 ...
	 */
	public boolean commit(GRootGroup currentState, int referenceVersion)
		throws RemoteException, VersionException, RepositoryException;

	/**
	 * Returns the tree representing the state of the graphical document at version <code>version</code>.
	 * <br /><br />
	 * @param version the version of the document the client wishes to retrieve
