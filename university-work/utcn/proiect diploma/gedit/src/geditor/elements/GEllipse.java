...
public class GEllipse extends GShape
{
	...
	public void merge(GShape rs, GShape os, boolean keeplocalversion)
	{
		...
		GEllipse re = (GEllipse) rs;
		GEllipse oe = (GEllipse) os;

		if (bottomRightPoint.equals(oe.bottomRightPoint) ||
		            (!keeplocalversion && !re.bottomRightPoint.equals(oe.bottomRightPoint)))
				bottomRightPoint = (Point2DDouble) re.bottomRightPoint.clone();

		if (topLeftPoint.equals(oe.topLeftPoint) ||
		            (!keeplocalversion && !re.topLeftPoint.equals(oe.topLeftPoint)))
				topLeftPoint = (Point2DDouble) re.topLeftPoint.clone();
	...
	public boolean equals(Object obj)
	{
		...
		if (!(obj instanceof GEllipse))
		{
			return false;
		}

		GEllipse ellipse = (GEllipse) obj;

		if (!(ellipse.getBottomRightPoint().equals(getBottomRightPoint())))
		{
			return false;
		}

		if (!(ellipse.getTopLeftPoint().equals(getTopLeftPoint())))
		{
			return false;
		}
