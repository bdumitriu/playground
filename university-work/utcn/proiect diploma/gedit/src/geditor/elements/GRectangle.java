...
public class GRectangle extends GShape
{
	...
	public void merge(GShape rs, GShape os, boolean keeplocalversion)
	{
		...
		GRectangle rr = (GRectangle) rs;
		GRectangle or = (GRectangle) os;

		if (bottomRightPoint.equals(or.bottomRightPoint) ||
		            (!keeplocalversion && !rr.bottomRightPoint.equals(or.bottomRightPoint)))
				bottomRightPoint = (Point2DDouble) rr.bottomRightPoint.clone();

		if (topLeftPoint.equals(or.topLeftPoint) ||
		            (!keeplocalversion && !rr.topLeftPoint.equals(or.topLeftPoint)))
				topLeftPoint = (Point2DDouble) rr.topLeftPoint.clone();
	...
	public boolean equals(Object obj)
	{
		...
		GRectangle rectangle = (GRectangle) obj;

		if (!(rectangle.getBottomRightPoint().equals(getBottomRightPoint())))
		{
			return false;
		}

		if (!(rectangle.getTopLeftPoint().equals(getTopLeftPoint())))
		{
			return false;
		}
