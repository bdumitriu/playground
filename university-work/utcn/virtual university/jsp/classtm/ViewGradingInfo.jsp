...
<%
	...
	String resourceName = new String("grading_info");
...
<h2>No grading information available at this time.</h2>
...
%>
The grading information can be found at:
<a	href="<%= url %>"
	onMouseOver="windowStatus('View grading information'); return true;"
...
<%
			...
			else if (description.equals("fil"))
			{
				...
				path.append("grading_info/");
				path.append(rs.getString(resourceName));
%>
You can download the grading information from here:
