...
abstract public class DateHelper
{
  ...
  public static void insert (org.omg.CORBA.Any a, core.interop.Date that)
  {
  ...
  public static core.interop.Date extract (org.omg.CORBA.Any a)
  {
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[5] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (core.interop.DateHelper.id (), "Date", _members0);
          __active = false;
        }
      }
    }
  ...
  public static core.interop.Date read (org.omg.CORBA.portable.InputStream istream)
  {
    core.interop.Date value = new core.interop.Date ();
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, core.interop.Date value)
  {
