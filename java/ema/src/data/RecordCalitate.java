...
/**
 * This class holds a record from the Calitate table.
 *
 * Author: Bogdan Dumitriu
 * Version: 0.1
 * Date: Dec 26, 2003
 */
public class RecordCalitate extends DBRecord
{
	/**
	 * Creates a new RecordCalitate, initializing its fields from the <code>resultSet</code> received as parameter.
	 * See {@link #setFromResultSet setFromResultSet} for details.
	 *
	 * @throws java.sql.SQLException if setFromResultSet throws it
	 */
	public RecordCalitate(ResultSet resultSet) throws SQLException
	{
		super(resultSet);
		setFromResultSet(resultSet);
	}

	public RecordCalitate(int id, String nume)
	{
		super(id);
		this.nume = nume;
	}
