...
/**
 * This class holds a record from the Solicitant table.
 *
 * Author: Bogdan Dumitriu
 * Version: 0.1
 * Date: Dec 26, 2003
 */
public class RecordSolicitant extends DBRecord
{
	/**
	 * Creates a new RecordSolicitant, initializing its fields from the <code>resultSet</code> received as parameter.
	 * See {@link #setFromResultSet setFromResultSet} for details.
	 *
	 * @throws java.sql.SQLException if setFromResultSet throws it
	 */
	public RecordSolicitant(ResultSet resultSet) throws SQLException
	{
		super(resultSet);
		setFromResultSet(resultSet);
	}

	public RecordSolicitant(int id, String nume)
	{
		super(id);
		this.nume = nume;
	}
