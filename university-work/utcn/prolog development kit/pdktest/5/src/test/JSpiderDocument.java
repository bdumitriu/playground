...
public class JSpiderDocument extends DefaultStyledDocument
{
	...
	/* see usage in fireXXXUpdate, insertString, remove and
	/* setCharacterAttributes methods */
	...
	private void initializeStyle()
	{
		...
		StyleConstants.setForeground(commentStyle,
		...
		StyleConstants.setForeground(variableStyle,
		        new Color(102, 14, 122));
	...
	{
		// an insert has been done, we need an update of the structure
		needUpdate = true;
	...
	/*
	 * Do a bit of syntax highlighting. <code>event</code> *should be*
	 * used in order not to rehighlight tokes that haven't changed.
