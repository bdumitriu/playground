        ...
        Comparable
{
	...
	public GGroup getParent2()
	{
		return parent2;
	}

	public void setParent2(GGroup parent2)
	{
		this.parent2 = parent2;
	}

	//used only in the merging process
	//usually null
	protected GGroup parent2 = null;
	...
	public GShape(int z, Color fgColor)
	{
		this(z);
		this.fgColor = fgColor;
	}

	public GShape(int z, Color fgColor, Color bgColor)
	{
		this(z);
		this.fgColor = fgColor;
	...
	// merges "this" with rs (remote shape)
	// os - orginal shape
	public void merge(GShape rs, GShape os, boolean keeplocalversion)
	{
		if (getBgColor().equals(os.getBgColor()) ||  (!keeplocalversion && !rs.getBgColor().equals(os.getBgColor())))
				setBgColor(rs.getBgColor());
	...
	public abstract void moveWith(double dx, double dy);
	...
	public boolean equals(Object obj)
	{
		...
		if (!(shape.getId().equals(getId())))
		{
			return false;
		}

		if(!(shape.getFgColor().equals(getFgColor())))
		{
			return false;
		}

		if (shape.getBgColor() == null && getBgColor() == null)
		{
			return true;
		}
		else if (!(shape.getBgColor().equals(getBgColor())))
		{
			return false;
		}
