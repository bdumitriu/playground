    ...
    \ _lhsIdispl
      ...
      _lhsItypeEnv ->
        let _lhsOcode :: (CodeGen)
            ...
            -- "SLPrettyprint.ag"(line 39, column 15)
            (_lhsOpp@_) =
            ...
            -- "SLTypecheck.ag"(line 74, column 15)
            (_inferredType@_) =
                text "<ERROR: Missing type annotation>"
            -- "SLTypecheck.ag"(line 73, column 15)
            (_declErr@_) =
                empty
            ...
            (_exprOexpType@_) =
                type_
            -- "SLCodeGen.ag"(line 64, column 15)
            (_lhsOlocalVarSize@_) =
                codeSize  type_
            ...
            -- "SLCodeGenEnv.ag"(line 44, column 11)
            (_lhsOdispl@_) =
    ...
    \ _lhsIdispl
      ...
      _lhsItypeEnv ->
        let _lhsOcode :: (CodeGen)
            ...
            (_lhsOpps@_) =
                _hdIpp :  _tlIpps
            -- "SLTypecheck.ag"(line 80, column 15)
            (_hdOtypeEnv@_) =
                _lhsItypeEnv
            -- "SLTypecheck.ag"(line 79, column 15)
            (_lhsOtypeEnv@_) =
                _hdItypeEnv ++  _tlItypeEnv
            -- "SLCodeGen.ag"(line 69, column 15)
            (_lhsOlocalVarsSize@_) =
                _hdIlocalVarSize +  _tlIlocalVarsSize
            -- "SLCodeGen.ag"(line 68, column 15)
            (_lhsOcode@_) =
                _hdIcode .  _tlIcode
            -- copy rule (up)
            (_lhsOdispl@_) =
    ...
    \ _lhsIdispl
      ...
      _lhsItypeEnv ->
        let _lhsOcode :: (CodeGen)
            ...
            _lhsOpps :: ([PP_Doc])
            _lhsOtypeEnv :: (TypeEnv)
            -- "SLPrettyprint.ag"(line 32, column 15)
            (_lhsOpps@_) =
                []
...
-}
{-
   local variables for Expr.While:
      condErr
      afterWhileLabel
      whileLabel
...
sem_Expr ((Expr_Unit )) =
    (sem_Expr_Unit )
sem_Expr ((Expr_While (_cond) (_expr))) =
    (sem_Expr_While ((sem_Expr (_cond))) ((sem_Expr (_expr))))
    ...
    \ _lhsIdispl
      ...
      _lhsItypeEnv ->
        let _lhsOcode :: (CodeGen)
            ...
            (_thenExprOdispl@_) =
                _lhsIdispl
            -- "SLLabel.ag"(line 12, column 11)
            (_condOlabel@_) =
                incrementLabel  _afterElseLabel
            -- "SLLabel.ag"(line 11, column 11)
            (_afterElseLabel@_) =
                incrementLabel  _lhsIlabel
            -- "SLLabel.ag"(line 10, column 11)
            (_afterThenLabel@_) =
                _lhsIlabel
            -- copy rule (up)
            (_lhsOdispl@_) =
    ...
    \ _lhsIdispl
      ...
      _lhsItypeEnv ->
        let _lhsOcode :: (CodeGen)
            ...
            ( _exprIcode,_exprIdispl,_exprIlabel,_exprIpp,_exprIresType) =
                (expr_ (_exprOdispl) (_exprOenv) (_exprOexpType) (_exprOlabel) (_exprOlevel) (_exprOtypeEnv))
            -- "SLPrettyprint.ag"(line 28, column 15)
            (_lhsOpp@_) =
                text "\\" >#<  _varsIpp >|<  _argErr >#< text "->"
                  >#<  _exprIpp >|<  _bodyErr
            -- "SLTypecheck.ag"(line 41, column 15)
            (_lhsOresType@_) =
            ...
            -- "SLCodeGenEnv.ag"(line 38, column 15)
            (_varsOenv@_) =
                _lhsIenv
            ...
            (_lamLevel@_) =
                _lhsIlevel + 1
            -- "SLLabel.ag"(line 18, column 11)
            (_exprOlabel@_) =
                incrementLabel  _afterLamLabel
            -- "SLLabel.ag"(line 17, column 11)
            (_afterLamLabel@_) =
                incrementLabel  _lhsIlabel
            -- "SLLabel.ag"(line 16, column 11)
            (_lamLabel@_) =
                _lhsIlabel
            -- copy rule (up)
            (_lhsOdispl@_) =
    ...
    \ _lhsIdispl
      ...
      _lhsItypeEnv ->
        let _lhsOcode :: (CodeGen)
            ...
            -- "SLCodeGen.ag"(line 47, column 15)
            (_lhsOcode@_) =
                _callIcode . (JSR:)
        ...
        let _lhsOcode :: (CodeGen)
            ...
            (_lhsOpp@_) =
                text  "let" >|< pp_block "" "" "; "  _declsIpps
                  >-< " in" >#< _exprIpp
                  >-< " ni"
            -- "SLTypecheck.ag"(line 24, column 15)
            (_lhsOresType@_) =
                _exprIresType
            -- "SLTypecheck.ag"(line 49, column 15)
            (_exprOtypeEnv@_) =
                _declsItypeEnv
            -- "SLCodeGen.ag"(line 36, column 15)
            (_lhsOcode@_) =
                _declsIcode
                .  _exprIcode
    ...
    \ _lhsIdispl
      ...
      _lhsItypeEnv ->
        let _lhsOcode :: (CodeGen)
            ...
            -- "SLPrettyprint.ag"(line 27, column 15)
            (_lhsOpp@_) =
                pp_block "" "" "; " (_exprsIpps)
            -- "SLTypecheck.ag"(line 42, column 15)
            (_lhsOresType@_) =
      ...
      _lhsItypeEnv ->
        let _lhsOcode :: (CodeGen)
            ...
            (_lhsOlabel@_) =
                _lhsIlabel
        in  ( _lhsOcode,_lhsOdispl,_lhsOlabel,_lhsOpp,_lhsOresType)
sem_Expr_While :: (T_Expr) ->
                  (T_Expr) ->
                  (T_Expr)
sem_Expr_While (cond_) (expr_) =
    \ _lhsIdispl
      _lhsIenv
      _lhsIexpType
      _lhsIlabel
      ...
      _lhsItypeEnv ->
        let _lhsOcode :: (CodeGen)
            ...
            (_lhsOpp@_) =
                text "while" >#< (_condIpp >|< _condErr) >#< "do"
                  >-< _exprIpp
                  >-< "od"
            -- "SLTypecheck.ag"(line 23, column 15)
            (_lhsOresType@_) =
                unittype
            -- "SLTypecheck.ag"(line 22, column 23)
            ((_,_condErr@_)) =
                matchTypes _condIresType booltype
            -- "SLCodeGen.ag"(line 29, column 15)
            (_lhsOcode@_) =
                (DEFLABEL _whileLabel:)
                .  _condIcode
                .  (BRF _afterWhileLabel:)
                .  _exprIcode
                .  (BRA _whileLabel:)
                .  (DEFLABEL _afterWhileLabel:)
            -- "SLCodeGenEnv.ag"(line 26, column 15)
            (_exprOdispl@_) =
                _lhsIdispl
            -- "SLLabel.ag"(line 15, column 11)
            (_condOlabel@_) =
                incrementLabel _afterWhileLabel
            -- "SLLabel.ag"(line 14, column 11)
            (_afterWhileLabel@_) =
                incrementLabel _lhsIlabel
            -- "SLLabel.ag"(line 13, column 11)
            (_whileLabel@_) =
                _lhsIlabel
            -- copy rule (up)
            (_lhsOdispl@_) =
    ...
    \ _lhsIdispl
      ...
      _lhsItypeEnv ->
        let _lhsOcode :: (CodeGen)
            ...
            (_lhsOpps@_) =
                _hdIpp :  _tlIpps
            -- "SLTypecheck.ag"(line 55, column 15)
            (_hdOtypeEnv@_) =
                _lhsItypeEnv
            ...
            -- "SLCodeGen.ag"(line 55, column 15)
            (_codesize@_) =
    ...
    \ _lhsIdispl
      ...
      _lhsItypeEnv ->
        let _lhsOcode :: (CodeGen)
            ...
            _lhsOpps :: ([PP_Doc])
            _lhsOresTypes :: (Types)
            -- "SLPrettyprint.ag"(line 43, column 15)
            (_lhsOpps@_) =
                []
            -- "SLTypecheck.ag"(line 56, column 15)
            (_lhsOresTypes@_) =
                []
            -- "SLCodeGen.ag"(line 54, column 15)
            (_lhsOcode@_) =
                id
            -- copy rule (chain)
            (_lhsOlabel@_) =
    ...
    \ _lhsIdispl
      ...
      _lhsIlevel ->
        let _lhsOdispl :: (Displ)
            ...
            -- "SLPrettyprint.ag"(line 48, column 15)
            (_lhsOpp@_) =
                text  hd_ >#<  _tlIpp
            ...
            (_tlOexpTypes@_) =
                _argtps
            -- "SLTypecheck.ag"(line 60, column 23)
            ((_argtp@_,_argtps@_)) =
                getFirstArgType  _lhsIexpTypes
            -- "SLCodeGen.ag"(line 73, column 15)
            (_lhsOparamsSize@_) =
                _tlIparamsSize + codeSize  _argtp
            -- "SLCodeGenEnv.ag"(line 48, column 11)
            (_tlOdispl@_) =
                _varDispl
    ...
    \ _lhsIdispl
      ...
      _lhsIlevel ->
        let _lhsOdispl :: (Displ)
            ...
            _lhsOresTypes :: (Types)
            _lhsOvariables :: ([String])
            -- "SLPrettyprint.ag"(line 47, column 15)
            (_lhsOpp@_) =
                empty
            -- "SLTypecheck.ag"(line 65, column 15)
            (_lhsOvariables@_) =
                []
            -- "SLTypecheck.ag"(line 64, column 15)
            (_lhsOresTypes@_) =
                []
            -- "SLCodeGen.ag"(line 72, column 15)
            (_lhsOparamsSize@_) =
                0
            -- copy rule (chain)
            (_lhsOdispl@_) =
