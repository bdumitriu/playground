...
<%
	...
	String resourceName = new String("references");
...
<h2>No references available at this time.</h2>
...
%>
<h1>The course references</h1>
<%
			if (description.equals("url"))
			{
				String url = rs.getString(resourceName);
%>
The course references can be found at:
<a	href="<%= url %>"
	onMouseOver="windowStatus('View course references'); return true;"
...
%>
You can download the course references from here:
