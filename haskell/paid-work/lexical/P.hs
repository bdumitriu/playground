...
data Feat = MascOrFem | Masc    | Fem  | Neutr 
          | Sg        | Pl 
          | Fst       | Snd     | Thrd 
          | Nom       | AccOrDat 
          | Pers      | Refl    | Wh 
...
lexicon "poor"   = [Cat "poor"   "CN" [Sg,Masc,Thrd]   []]
lexicon "poor"   = [Cat "poor"   "CN" [Pl,Masc,Thrd]   []]


lexicon "princess" = [Cat "princess" "CN" [Sg,Fem,Thrd] []]
lexicon "princesses" = 
   [Cat "princesses" "CN" [Pl,Fem,Thrd] []]
...
lexicon "swords"   = [Cat "sword"    "CN" [Pl,Neutr,Thrd] []]
...
lexicon "helps"         = 
  [Cat "helps"     "VP" [Infl]  [Cat "_" "NP" [AccOrDat] []]]
lexicon "defeated"       = 
