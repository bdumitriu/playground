...
{
	function Member($id = 0, $lastName = "", $firstName = "", $emailAddress = "")
	{
		parent::DBClass();
	 ...
	 */
	function addToGroup($membershipGroup)
	{
	 ...
	 * @return boolean true if the id of $membershipGroup is valid and false otherwise
	 */
	function removeFromGroup($membershipGroup)
	{
		$id = $membershipGroup->getId();
		if (is_null($id) || ($id == ""))
		{
	 ...
	 *	from the database
	 */
	function getAvailableMembersFor($id)
	{
