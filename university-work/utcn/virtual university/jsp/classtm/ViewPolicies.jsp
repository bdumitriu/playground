...
<%
	...
	String resourceName = new String("policies");
...
<h2>No policies information available at this time.</h2>
...
%>
Information about the class policies can be found at:
<a	href="<%= url %>"
	onMouseOver="windowStatus('View class policies'); return true;"
...
<%
			...
			else if (description.equals("fil"))
			{
				...
				path.append("policies/");
				path.append(rs.getString(resourceName));
%>
You can download the class policies from here:
