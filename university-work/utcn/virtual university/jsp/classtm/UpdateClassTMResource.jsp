...
<h2>The <%= data.getResourceName() %> class resource has been updated successfully.</h2>
...
%>
<h2>
Something went wrong while trying to update the <%= data.getResourceName() %> class resource.<br />
