...
/**
 * This class holds a record from the Domeniu table.
 *
 * Author: Bogdan Dumitriu
 * Version: 0.1
 * Date: Dec 26, 2003
 */
public class RecordDomeniu extends DBRecord
{
	/**
	 * Creates a new RecordDomeniu, initializing its fields from the <code>resultSet</code> received as parameter.
	 * See {@link #setFromResultSet setFromResultSet} for details.
	 *
	 * @throws java.sql.SQLException if setFromResultSet throws it
	 */
	public RecordDomeniu(ResultSet resultSet) throws SQLException
	{
		super(resultSet);
		setFromResultSet(resultSet);
	}

	public RecordDomeniu(int id, String nume)
	{
		super(id);
		this.nume = nume;
	}
