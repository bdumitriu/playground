 ...
 */
public class MovieConstraintViaShowingToggler extends ConstraintToggler {

    public MovieConstraintViaShowingToggler(EntityManager entityManager, Showing showing,
